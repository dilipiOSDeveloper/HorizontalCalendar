...
class UsedDates {
    ...
    func getMonthLetter(dayMonthNumber: Int) -> String {
        switch dayMonthNumber {
        case 1:
            return "Jan"
        case 2:
            return "Feb"
    ...
    var displayedDateString: String {
        get {
            ...
            longDateFormatter.dateFormat = "yyyy-MM-dd"//"EEEE, d MMM yyyy"
    ...
    var displayedMonthString: String {
        get {
            let longDateFormatter = DateFormatter()
            longDateFormatter.dateFormat = "MMM"//"EEEE, d MMM yyyy"
            return longDateFormatter.string(from: displayedDate)
        }
    }
}
